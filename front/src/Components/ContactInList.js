    ...
    return (
        <div>
            {props.contact.nickname ?
                ...
                : <div className="contact" onClick={handleShowEditForm}>
                    <h1><img className="contact_photo" src={props.contact.photo[0]} alt={props.contact.first_name} style={getImageStyle(JSON.parse(props.contact.photo[1]))} />
            ...
            <Modal show={showEditForm} onHide={handleCloseEditForm}>
                ...
                <Modal.Body className="add-modal"><UpdateContactForm contact={props.contact} getContacts={props.getContacts} handleCloseEditForm={handleCloseEditForm}></UpdateContactForm></Modal.Body>
